                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      {pct > 0 && (
                        <span
                          className={`shrink-0 rounded-full px-2 py-0.5 text-[10px] font-bold border ${pillColor}`}
                        >
                          {pct}% match
                        </span>
                      )}
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="shrink-0 rounded-lg bg-gradient-to-r from-blue-600 to-violet-600 px-3.5 py-1.5 text-[11px] font-semibold text-white transition-all hover:shadow-md hover:shadow-blue-500/20 hover:scale-[1.02] active:scale-[0.98]"
                      >
                        Apply →
                      </a>
                    </div>
